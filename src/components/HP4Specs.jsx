...
import hp4Schematic from '../assets/hp4-schematic.jpg';
import gsap from 'gsap';
import { ArrowLeft, Box, Camera, Globe, Power, ShieldCheck, Smartphone, Wifi, Mic, Speaker, HardDrive } from 'lucide-react';

export default function HP4Specs() {
    ...
    const specGroups = [
        {
            ...
            items: [
                { label: "Prečnik otvora", value: "15.5 do 50 mm" },
        ...
        },
        {
            ...
            items: [
                ...
                { label: "Objektiv", value: "2.0 mm @ F2.2, ugao (dijagonalno): 155°" },
                { label: "Dan/Noć prekidač", value: "ICR infracrveni filter" },
                { label: "IR domet", value: "Max. 3 m" },
                { label: "Rezolucija", value: "1080p / 2MP" },
                { label: "Frame Rate", value: "15fps" }
            ]
        },
        {
            title: "Interfejs i Audio",
            icon: <Mic size={20} className="text-accent" />,
            items: [
                { label: "Slot za karticu", value: "MicroSD slot (max. 512 GB)" },
        ...
        },
        {
            ...
            items: [
                ...
                { label: "Video interfon", value: "Lokalni i daljinski video interfon" },
        ...
        },
        {
            ...
            items: [
                ...
                { label: "Radni uslovi", value: "-10°C do 45°C" },
                { label: "Napajanje", value: "DC 5V (±10%)" },
                { label: "Potrošnja", value: "Max. 2.2W" },
                { label: "Težina", value: "302g" }
            ]
        }
    ];
                ...
                <div className="flex flex-col md:flex-row gap-16 items-start mb-24">
                    <div className="flex-1 spec-block">
                        <h1 className="font-heading font-bold text-5xl md:text-7xl uppercase tracking-tighter mb-4 leading-none">
                            EZVIZ <span className="text-accent italic font-drama lg:text-8xl">HP4</span>
                        </h1>
                        <p className="font-mono text-sm text-dark/60 uppercase tracking-widest mb-12">
                            Detaljne Tehničke Specifikacije
                        </p>

                        <div className="bg-dark/5 border border-dark/5 p-8 rounded-[2rem] overflow-hidden shadow-sm flex items-center justify-center min-h-[300px]">
                            <img
                                src={hp4Schematic}
                                alt="EZVIZ HP4 Schematic"
                    ...
                    <div className="spec-block md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-12 bg-dark text-paper p-10 rounded-[3rem] mt-12">
                        <div>
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-2 font-mono text-xs uppercase tracking-wider text-paper/60">
                                <li>- HP4 Špijunka sa zvonom</li>
                                <li>- Displej</li>
                                <li>- Nosač</li>
                                <li>- Kabl za napajanje (1 m)</li>
                                <li>- Šrafovi × 6</li>
                        ...
                        <div className="flex flex-col justify-center border-t md:border-t-0 md:border-l border-paper/10 pt-8 md:pt-0 md:pl-12">
                            ...
                            <p className="font-mono text-sm tracking-widest text-accent uppercase">UL / CE / WEEE / REACH / RoHS</p>
                        </div>
                    </div>
                </div>
